#  🛠 오픈웨더맵과 am4maps api를 활용하여 각 국가별 수도의 날씨 현황을 확인할 수 있는 리액트 프로젝트입니다.
...
<h3> 현재 위치 </h3>
<div>
날씨 웹 사이트 접속 시 기본적으로 현재 위치를 기반의 날씨 현황을 보여주고 하단에는 세계 지도를 보여줍니다.
</div>
<div>
...
<h3> 현재 위치 다시 확인 </h3>
<div>
 <div> 현재 위치 버튼을 클릭 시 다시 현재 위치의 날씨 현황을 보여줍니다. </div>
</div>
<div>
 <img width="100%" src="https://github.com/user-attachments/assets/96410ff4-0d81-4fe3-95fd-a4b1cdf9c50d"/>
</div>
